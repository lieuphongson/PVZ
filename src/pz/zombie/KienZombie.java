...
public class KienZombie extends Zombie {
	...
	public KienZombie(Position pos) {
		super("MaleZombie", hp, damage, attackInterval, speed, pos);
		attackAni = AnimationLoader.getAnimationFromFolder("res/ZombieTest/KienZombie/attack", 110);
	...
	protected void loadAnimation() {
		setAnimation(AnimationLoader.getAnimationFromFolder("res/ZombieTest/KienZombie/walk", 110));
	}
